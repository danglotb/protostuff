...
public class ProtobufIOUtil_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "io.protostuff.ProtobufIOUtil"; 
  ...
  public static void setSystemProperties() {
    ...
    System.setProperty("java.class.path", "/tmp/EvoSuite_pathingJar5474796367890054816.jar");
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ProtobufIOUtil_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "io.protostuff.ProtobufIOUtil$2",
      "io.protostuff.ProtobufIOUtil$1",
  ...
  public static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("io.protostuff.Schema", false, ProtobufIOUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Enumeration", false, ProtobufIOUtil_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ProtobufIOUtil_ESTest_scaffolding.class.getClassLoader()); 
