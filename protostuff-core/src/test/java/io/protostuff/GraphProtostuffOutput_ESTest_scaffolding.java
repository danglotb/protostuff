...
public class GraphProtostuffOutput_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "io.protostuff.GraphProtostuffOutput"; 
  ...
  public static void setSystemProperties() {
    ...
    System.setProperty("java.class.path", "/tmp/EvoSuite_pathingJar5060007019055346498.jar");
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GraphProtostuffOutput_ESTest_scaffolding.class.getClassLoader() ,
  ...
  public static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("io.protostuff.Schema", false, GraphProtostuffOutput_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.protostuff.WriteSession$FlushHandler", false, GraphProtostuffOutput_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GraphProtostuffOutput_ESTest_scaffolding.class.getClassLoader()); 
