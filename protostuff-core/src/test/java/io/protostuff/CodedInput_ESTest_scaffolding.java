...
public class CodedInput_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "io.protostuff.CodedInput"; 
  ...
  public static void setSystemProperties() {
    ...
    System.setProperty("java.class.path", "/tmp/EvoSuite_pathingJar3949312713432170845.jar");
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CodedInput_ESTest_scaffolding.class.getClassLoader() ,
  ...
  public static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("io.protostuff.Schema", false, CodedInput_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Enumeration", false, CodedInput_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CodedInput_ESTest_scaffolding.class.getClassLoader()); 
