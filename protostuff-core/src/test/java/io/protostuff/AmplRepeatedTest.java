 ...
 *
 */
public class AmplRepeatedTest extends AbstractTest {
    ...
    public void testPackedRepeatedByteBuffer() throws java.io.IOException {
        final LinkedBuffer buffer = getProtobufBuffer();
        PojoWithRepeated test = new PojoWithRepeated();
        test.mergeFrom(new ByteBufferInput(java.nio.ByteBuffer.wrap(buffer.buffer, 0, buffer.offset), false), test);
        verify(test);
    }
    ...
    private LinkedBuffer getProtobufBuffer() throws java.io.IOException {
    ...
    private void verify(final PojoWithRepeated test) {
        ...
        junit.framework.TestCase.assertEquals(((Integer) (3)), test.getSomeInt32(0));
        junit.framework.TestCase.assertEquals(((Integer) (270)), test.getSomeInt32(1));
        junit.framework.TestCase.assertEquals(((Integer) (1234)), test.getSomeInt32(2));
        junit.framework.TestCase.assertEquals(((Integer) (86942)), test.getSomeInt32(3));
        junit.framework.TestCase.assertEquals(2, test.getSomeFixed64Count());
        junit.framework.TestCase.assertEquals(((Long) (8L)), test.getSomeFixed64(0));
        junit.framework.TestCase.assertEquals(((Long) (9L)), test.getSomeFixed64(1));
    }
    ...
    public void testPackedRepeatedByteArray_literalMutation6_failAssert3() throws java.io.IOException {
        ...
        try {
            final LinkedBuffer buffer = getProtobufBuffer();
            PojoWithRepeated test = new PojoWithRepeated();
            test.mergeFrom(new ByteArrayInput(buffer.buffer, 2, buffer.offset, false), test);
            verify(test);
    ...
    /* amplification of io.protostuff.RepeatedTest#testPackedRepeatedByteArray */
    /* amplification of io.protostuff.RepeatedTest#testPackedRepeatedByteArray_add1 */
    ...
    /* amplification of io.protostuff.RepeatedTest#testPackedRepeatedByteArray */
    /* amplification of io.protostuff.RepeatedTest#testPackedRepeatedByteArray_add1 */
    /* amplification of io.protostuff.RepeatedTest#testPackedRepeatedByteArray_add1_failAssert0_literalMutation17 */
    @org.junit.Test(timeout = 10000)
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    // MethodCallAdder
                    test.mergeFrom(new ByteArrayInput(buffer.buffer, 2, buffer.offset, false), test);
                    test.mergeFrom(new ByteArrayInput(buffer.buffer, -1, buffer.offset, false), test);
                    verify(test);
                    org.junit.Assert.fail("testPackedRepeatedByteArray_add1 should have thrown UnsupportedOperationException");
                } catch (UnsupportedOperationException eee) {
                }
    ...
    public void testPackedRepeatedCodedInput_literalMutation155_failAssert2() throws java.io.IOException {
        ...
        try {
            final LinkedBuffer buffer = getProtobufBuffer();
            PojoWithRepeated test = new PojoWithRepeated();
            test.mergeFrom(new CodedInput(buffer.buffer, -1, buffer.offset, false), test);
            verify(test);
    ...
    public void testPackedRepeatedCodedInput_literalMutation157_failAssert3() throws java.io.IOException {
        ...
        try {
            final LinkedBuffer buffer = getProtobufBuffer();
            PojoWithRepeated test = new PojoWithRepeated();
            test.mergeFrom(new CodedInput(buffer.buffer, 2, buffer.offset, false), test);
            verify(test);
    ...
    /* amplification of io.protostuff.RepeatedTest#testPackedRepeatedCodedInput */
    /* amplification of io.protostuff.RepeatedTest#testPackedRepeatedCodedInput_add152 */
    @org.junit.Test(timeout = 10000)
    ...
    /* amplification of io.protostuff.RepeatedTest#testPackedRepeatedCodedInput */
    /* amplification of io.protostuff.RepeatedTest#testPackedRepeatedCodedInput_add152 */
    /* amplification of io.protostuff.RepeatedTest#testPackedRepeatedCodedInput_add152_failAssert0_literalMutation170 */
    @org.junit.Test(timeout = 10000)
    ...
    /* amplification of io.protostuff.RepeatedTest#testPackedRepeatedCodedInput */
    /* amplification of io.protostuff.RepeatedTest#testPackedRepeatedCodedInput_add152 */
    /* amplification of io.protostuff.RepeatedTest#testPackedRepeatedCodedInput_add152_failAssert0_literalMutation168 */
    @org.junit.Test(timeout = 10000)
