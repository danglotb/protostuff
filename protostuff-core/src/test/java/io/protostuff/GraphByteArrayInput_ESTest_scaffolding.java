...
public class GraphByteArrayInput_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "io.protostuff.GraphByteArrayInput"; 
  ...
  public static void setSystemProperties() {
    ...
    System.setProperty("java.class.path", "/tmp/EvoSuite_pathingJar4790639924974753212.jar");
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GraphByteArrayInput_ESTest_scaffolding.class.getClassLoader() ,
  ...
  public static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("io.protostuff.Schema", false, GraphByteArrayInput_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GraphByteArrayInput_ESTest_scaffolding.class.getClassLoader()); 
