 ...
 * @author Ryan Rawson
 */
public class AmplLowCopyProtobufOutputTest extends junit.framework.TestCase {
    ...
    private void deserTest(Message origMsg, Schema sch, java.nio.ByteBuffer buf) throws java.io.IOException {
    ...
    private java.nio.ByteBuffer testObj(Message msg, Schema sch) throws java.io.IOException {
        // do protostuff now:
