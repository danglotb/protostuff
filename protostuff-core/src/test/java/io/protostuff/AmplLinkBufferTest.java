...
public class AmplLinkBufferTest {
    ...
    public void testBasics_cf94_failAssert71() throws Exception {
    ...
    /* amplification of io.protostuff.LinkBufferTest#testBasics */
    @org.junit.Test(timeout = 10000)
    public void testBasics_cf97_failAssert73() throws Exception {
        // AssertGenerator generate try/catch block with fail statement
        try {
            LinkBuffer buf = new LinkBuffer(8);
            // put in 4 longs:
    ...
    /* amplification of io.protostuff.LinkBufferTest#testBasics */
    @org.junit.Test(timeout = 10000)
    public void testBasics_cf132_failAssert97() throws Exception {
        // AssertGenerator generate try/catch block with fail statement
        try {
            LinkBuffer buf = new LinkBuffer(8);
            // put in 4 longs:
    ...
    /* amplification of io.protostuff.LinkBufferTest#testGetBuffers_cf2682 */
    @org.junit.Test(timeout = 10000)
    public void testGetBuffers_cf2682_failAssert41_literalMutation2828_failAssert51() throws Exception {
        // AssertGenerator generate try/catch block with fail statement
        try {
            // AssertGenerator generate try/catch block with fail statement
            try {
                LinkBuffer b = new LinkBuffer(16);
                b.writeInt32(42);
                b.writeInt32(43);
                b.writeInt32(44);
                java.util.List<java.nio.ByteBuffer> buffers = b.getBuffers();
                ...
                java.nio.ByteBuffer vc_205 = (java.nio.ByteBuffer)null;
                // StatementAdderOnAssert create null value
                LinkBuffer vc_203 = (LinkBuffer)null;
                // StatementAdderMethod cloned existing statement
                vc_203.writeByteBuffer(vc_205);
                // MethodAssertGenerator build local variable
                Object o_28_0 = buffers.get(1).getInt();
                org.junit.Assert.fail("testGetBuffers_cf2682 should have thrown NullPointerException");
            } catch (NullPointerException eee) {
            }
            org.junit.Assert.fail("testGetBuffers_cf2682_failAssert41_literalMutation2828 should have thrown IndexOutOfBoundsException");
    ...
    @org.junit.Test(timeout = 10000)
    public void testGetBuffers_cf2666_failAssert39_literalMutation2813_failAssert7_literalMutation3183_failAssert43() throws Exception {
        // AssertGenerator generate try/catch block with fail statement
        try {
            // AssertGenerator generate try/catch block with fail statement
            try {
                // AssertGenerator generate try/catch block with fail statement
                try {
                    LinkBuffer b = new LinkBuffer(14);
                    b.writeInt32(42);
                    b.writeInt32(43);
                    b.writeInt32(44);
                    java.util.List<java.nio.ByteBuffer> buffers = b.getBuffers();
    ...
    @org.junit.Test(timeout = 10000)
    public void testGetBuffersAndAppendData_cf3862_failAssert44_literalMutation4198_failAssert2() throws Exception {
        // AssertGenerator generate try/catch block with fail statement
        try {
            // AssertGenerator generate try/catch block with fail statement
            try {
