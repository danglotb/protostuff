...
public class ProtobufOutput_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "io.protostuff.ProtobufOutput"; 
  ...
  public static void setSystemProperties() {
    ...
    System.setProperty("java.class.path", "/tmp/EvoSuite_pathingJar8694850232382932649.jar");
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ProtobufOutput_ESTest_scaffolding.class.getClassLoader() ,
  ...
  public static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("io.protostuff.Schema", false, ProtobufOutput_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ProtobufOutput_ESTest_scaffolding.class.getClassLoader()); 
